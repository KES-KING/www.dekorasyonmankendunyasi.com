...
$heroImage = mediaUrl((string) siteSetting($siteSettings, 'hero_image', $data['heroImage'] ?? asset('images/hero.jpg')));
$heroKicker = (string) siteSetting($siteSettings, 'hero_kicker', t('hero.kicker', 'Fashion | Design | Culture'));
$heroDescription = (string) siteSetting($siteSettings, 'hero_description', t('hero.description', 'A bold visual atelier for statement looks, editorial design language, and high-impact digital storytelling.'));
$heroCtaShop = (string) siteSetting($siteSettings, 'hero_cta_shop', t('hero.cta_shop', 'Explore Collection'));
$heroCtaDesigns = (string) siteSetting($siteSettings, 'hero_cta_designs', t('hero.cta_designs', 'View Designs'));
